...
&kp LGUI,          &kp LALT,          &kp LCTRL,         U_MT(LSHFT, ESC),  U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            \
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              U_MT(LSHFT, DEL),  &kp LCTRL,         &kp LALT,          &kp LGUI,          \
